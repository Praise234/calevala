...
const HomePage = () => {
    return (
        <div className="bg-customColors-bg  lg:p-3 lg:px-7 p-5 px-3 flex-1 flex flex-col justify-center">
            <div className="flex-1 block max-w-[94.5em] w-full m-auto lg:pb-[148px]  font-passion-one flex flex-col lg:justify-center leading-[80px] md:leading-[120px] lg:leading-[200px] justify-center">
